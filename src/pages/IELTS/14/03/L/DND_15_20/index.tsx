...
const DND = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - overcome physical difficulties" },
      "b": { id: "b", content: "B - rediscover skills not used for a long time" },
      "c": { id: "c", content: "C - improve their communication skills" },
      "d": { id: "d", content: "D - solve problems independently" },
      "e": { id: "e", content: "E - escape isolation" },
      "f": { id: "f", content: "F - remember past times" },
      "g": { id: "g", content: "G - start a new hobby" },
  ...
  const [flag, setFlag] = useState(flags['15'])
