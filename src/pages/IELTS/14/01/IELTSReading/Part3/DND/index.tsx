...
const DND = () => {
  ...
  const init = {
    ...
    columns: {
      ...
      26: {
        id: 26,
        title: "Hotel managers need to know what would encourage good staff to remain.",
        taskIds: localStorage.getItem('00026') ? localStorage.getItem('00026')?.split("") : []
      },
      27: {
        id: 27,
        title: "The actions of managers may make staff feel they shouldn’t move to a different employer.",
