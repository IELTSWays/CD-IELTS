...
const index = ({ qn }: any) => {
  ...
  // answer, setAnswer
  const [answer, setAnswer] = useState(answersAll['25']);

  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setAnswer((event.target as HTMLInputElement).value);
    dispatch(setAnswersAll(Object.assign({}, answersAll, { '25': ((event.target as HTMLInputElement).value) })))
  };
    ...
    >
      <div className="align-items-start justify-content-space-between type-radio">
        ...
        <Typography>
            ...
            <Typography sx={{ px: 1 }} className="question"> {t('00067')} </Typography>
          </Typography>
        </Paper>
