...
const DND = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - all downhill" },
      "b": { id: "b", content: "B - suitable for beginners" },
      "c": { id: "c", content: "C - only in good weather" },
      "d": { id: "d", content: "D - food included" },
      "e": { id: "e", content: "E - no charge" },
      "f": { id: "f", content: "F - swimming possible" },
      "g": { id: "g", content: "G - fully booked today" },
      "h": { id: "h", content: "H - transport not included" }
