...
const DND = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - translated into many other languages" },
      "b": { id: "b", content: "B - hard to read" },
      "c": { id: "c", content: "C - inspired a work in a different area of art" },
      "d": { id: "d", content: "D - more popular than the author’s other works" },
      "e": { id: "e", content: "E - original title refers to another book" },
      "f": { id: "f", content: "F - started a new genre" },
      "g": { id: "g", content: "G - unlikely topic" }
