...
const DND_25_30 = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - It could cause excessive sweating." },
      "b": { id: "b", content: "B - The material was being mass produced for another purpose." },
      "c": { id: "c", content: "C - People often needed to make their own." },
      "d": { id: "d", content: "D - It often had to be replaced." },
      "e": { id: "e", content: "E - The material was expensive." },
      "f": { id: "f", content: "F - It was unpopular among spectators." },
      "g": { id: "g", content: "G - It caused injuries." },
      "h": { id: "h", content: "H - No one ring it liked it at first." }
    },
    columns: {
      "column-1": {
        id: "column-1",
