...
const DND_15_20 = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - shopping" },
      "b": { id: "b", content: "B - watching cows being milked" },
      "c": { id: "c", content: "C - seeing old farming equipment" },
      "d": { id: "d", content: "D - eating and drinking" },
      "e": { id: "e", content: "E - starting a trip" },
      "f": { id: "f", content: "F - seeing rare breeds of animals" },
      "g": { id: "g", content: "G - helping to look after animals" },
      "h": { id: "h", content: "H - using farming tools" }
    },
    columns: {
      "column-1": {
        id: "column-1",
