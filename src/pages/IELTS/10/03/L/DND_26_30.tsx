...
const DND_26_30 = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - be on time" },
      "b": { id: "b", content: "B - get a letter of recommendation" },
      "c": { id: "c", content: "C - plan for the final year" },
      "d": { id: "d", content: "D - make sure the institution’s focus is relevant" },
      "e": { id: "e", content: "E - show ability in Theatre Studies" },
      "f": { id: "f", content: "F - make travel arrangements and bookings" },
      "g": { id: "g", content: "G - ask for help" },
    },
    columns: {
      "column-1": {
        id: "column-1",
