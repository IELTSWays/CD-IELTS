...
const DND_25_30 = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - company manager" },
      "b": { id: "b", content: "B - company’s personnel department" },
      "c": { id: "c", content: "C - personal tutor" },
      "d": { id: "d", content: "D - psychology department" },
      "e": { id: "e", content: "E - mentor" },
      "f": { id: "f", content: "F - university careers officer" },
      "g": { id: "g", content: "G - internet" },
    },
    columns: {
      "column-1": {
        id: "column-1",
      ...
      28: {
        id: 28,
        title: "responding to invitation for interview",
        taskIds: localStorage.getItem('28') ? localStorage.getItem('28')?.split("") : []
      },
      29: {
        id: 29,
        title: "informing about outcome of interview",
