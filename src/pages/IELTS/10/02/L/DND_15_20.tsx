...
const DND_15_20 = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - ancient forts" },
      "b": { id: "b", content: "B - waterways" },
      "c": { id: "c", content: "C - ice and snow" },
      "d": { id: "d", content: "D - jewels" },
      "e": { id: "e", content: "E - local animals" },
      "f": { id: "f", content: "F - mountains" },
      "g": { id: "g", content: "G - music and film" },
      "h": { id: "h", content: "H - space travel" },
      "i": { id: "i", content: "I - volcanoes" },
    },
    columns: {
      "column-1": {
        id: "column-1",
        title: "",
        taskIds: ["a", "b", "c", "d", "e", "f", "g", "h", "i"].filter(x =>
