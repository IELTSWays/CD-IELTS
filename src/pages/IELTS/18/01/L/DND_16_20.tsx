...
const DND_16_20 = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - experience on stage." },
      "b": { id: "b", content: "B - original, new ideas" },
      "c": { id: "c", content: "C - parenting skills" },
      "d": { id: "d", content: "D - an understanding of food and diet" },
      "e": { id: "e", content: "E - retail experience" },
      "f": { id: "f", content: "F - a good memory" },
      "g": { id: "g", content: "G - a good level of fitness" },
    },
    columns: {
      "column-1": {
        id: "column-1",
