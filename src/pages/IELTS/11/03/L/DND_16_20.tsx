...
const DND_16_20 = () => {
  ...
  const init = {
    tasks: {
      "a": { id: "a", content: "A - It will move to a new location." },
      "b": { id: "b", content: "B - It will have its opening hours extended." },
      "c": { id: "c", content: "C - It will be refurbished." },
      "d": { id: "d", content: "D - It will be used for a different purpose." },
      "e": { id: "e", content: "E - It will have its opening hours reduced." },
      "f": { id: "f", content: "F - It will have new management." },
      "g": { id: "g", content: "G - It will be expanded." },
    },
    columns: {
      "column-1": {
        id: "column-1",
      ...
      16: {
        id: 16,
        title: "railway station car park",
